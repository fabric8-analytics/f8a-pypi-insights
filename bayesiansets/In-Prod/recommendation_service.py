...
from src.models.predict_model import BSScoring
...
recommender = BSScoring(num_recom=30, data_store=s3_client)
...
@app.route('/api/v1/companion_recommendation_HPF_Backup', methods=['POST'])
def recommendation_backup():
